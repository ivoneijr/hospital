...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { cidade: @paciente.cidade, cpf: @paciente.cpf, dtnascto: @paciente.dtnascto, endereco: @paciente.endereco, nome: @paciente.nome, uf: @paciente.uf }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { cidade: @paciente.cidade, cpf: @paciente.cpf, dtnascto: @paciente.dtnascto, endereco: @paciente.endereco, nome: @paciente.nome, uf: @paciente.uf }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
